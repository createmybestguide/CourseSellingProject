...
export const metadata: Metadata = {
  title: "Testimonials",
  description: "Student reviews, video testimonials, and success stories from career-focused training programs.",
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {testimonials.map((item) => (
            <article className="card p-6" key={item.name}>
              <FaPlayCircle className="text-3xl text-[var(--brand)]" aria-label="Video testimonial placeholder" />
